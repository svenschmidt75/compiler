...
#define INITIAL	0
#define SECT2	49
#define CODEBLOCK	120
#define PICKUPDEF	125
#define SC	131
#define CARETISBOL	140
#define NUM	143
#define QUOTE	151
#define FIRSTCCL	163
#define CCL	262
#define ACTION	363
#define COMMENT	379
#define ACTION_STRING	385
#define LINEDIR	393
#define ACTION_COMMENT	395
#define SC_INCLUDE	401


//Number of DEA-States
#define	SSLEX_STATE	408
...
private:
	...
	static ulong	regTextIndex379[];
	static ulong	regTextIndex380[];
	static ulong	regTextIndex381[];
	static ulong	regTextIndex382[];
	static ulong	regTextIndex383[];
	static ulong	regTextIndex384[];
	static ulong	regTextIndex385[];
	static ulong	regTextIndex386[];
	static ulong	regTextIndex387[];
	static ulong	regTextIndex388[];
	static ulong	regTextIndex389[];
	static ulong	regTextIndex390[];
	static ulong	regTextIndex391[];
	static ulong	regTextIndex392[];
	static ulong	regTextIndex393[];
	static ulong	regTextIndex394[];
	static ulong	regTextIndex395[];
	static ulong	regTextIndex396[];
	static ulong	regTextIndex397[];
	static ulong	regTextIndex398[];
	static ulong	regTextIndex399[];
	static ulong	regTextIndex400[];
	static ulong	regTextIndex401[];
	static ulong	regTextIndex402[];
	static ulong	regTextIndex403[];
	static ulong	regTextIndex404[];
	static ulong	regTextIndex405[];
	static ulong	regTextIndex406[];
	static ulong	regTextIndex407[];
