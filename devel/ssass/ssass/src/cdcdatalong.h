 ...
 ***************************************************************************/
#ifndef CDCDATALONG_H
#define CDCDATALONG_H
...
@author Sven Schmidt
*/
class CDCDataLong : public CDCData
{
public:
	CDCDataLong();
	~CDCDataLong();
	...
	friend std::ostream &operator<<( std::ostream &, const CDCDataLong & );
	...
	void insertElement( unsigned long );
