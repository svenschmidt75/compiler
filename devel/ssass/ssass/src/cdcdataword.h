 ...
 ***************************************************************************/
#ifndef CDCDATAWORD_H
#define CDCDATAWORD_H
...
@author Sven Schmidt
*/
class CDCDataWord : public CDCData
{
public:
	CDCDataWord();
	~CDCDataWord();
	...
	friend std::ostream &operator<<( std::ostream &, const CDCDataWord & );
	...
	void insertElement( unsigned short );


private:

	//Array mit den Shorts (16 Bit)
	std::vector<unsigned short>	_array;
};
