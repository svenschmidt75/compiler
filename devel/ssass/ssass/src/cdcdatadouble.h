 ...
 ***************************************************************************/
#ifndef CDCDATADOUBLE_H
#define CDCDATADOUBLE_H
...
@author Sven Schmidt
*/
class CDCDataDouble : public CDCData
{
public:
	CDCDataDouble();
	~CDCDataDouble();
	...
	friend std::ostream &operator<<( std::ostream &, const CDCDataDouble & );
