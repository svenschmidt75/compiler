...
CDCDataLong::CDCDataLong() : CDCData()
{
}


CDCDataLong::~CDCDataLong()
{
}


unsigned long CDCDataLong::getSize( void ) const
{
	//die Größe dieses Bereichs zurückliefern
	unsigned long	_size = _array.size();
	unsigned char	_typeSize = sizeof( unsigned long );
...
CDCData::_typeId CDCDataLong::getInternType( void ) const
{
...
void CDCDataLong::insertElement( unsigned long elem )
{
...
std::ostream &operator<<( std::ostream &os, const CDCDataLong &cls )
{
	//die Daten ausgeben
